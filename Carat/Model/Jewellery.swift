...
struct Jewellery: Codable, Identifiable {
    let id: UUID
    var title: String
    var subtitle: String
    ...
    init(title: String, subtitle: String, description: String, price: String) {
        self.id = UUID()
        self.title = title
...
class Catalogue {
    var jewelleries = [Jewellery.caledonia, Jewellery.edmonia, Jewellery.scarlett, Jewellery.nefertari, Jewellery.carmine, Jewellery.ambrette]
}
